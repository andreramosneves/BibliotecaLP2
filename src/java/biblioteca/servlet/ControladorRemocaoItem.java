 ...
 * @author Andre
 */
public class ControladorRemocaoItem implements ControllerInterface {
...
//            Us dao = SessionUtils.getUsuarioDao(session, conexao);
            ...
            DaoGenerico<ItemEmprestimo> dao = new ItemDaoRelacional(conexao);
           
            ItemEmprestimo u = new ItemEmprestimo();
            u.setIdItem(Integer.parseInt(request.getParameter("id")));
            dao.delete(u);
